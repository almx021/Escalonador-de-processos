...
class SimulationPanel(Screen, Observer):
    ...
    def render(self):
        ...
        self.memory_bar.place(relx=0.05, relwidth=0.3, rely=0.05, relheight=0.8)
        ...
        self.current_processes_table.place(relx=0.38, relwidth=0.35, rely=0.05, relheight=0.8)
        self.current_processes_table.render()

    def alert(self):
        self.memory_bar_controller.draw_processes(self.simulation_data_reporter.data)